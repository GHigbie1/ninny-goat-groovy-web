...
const Index = () => {
  ...
  const fadeInClass = (id: string) => 
    visible[id] ? 'opacity-100 translate-y-0 transition-all duration-1000' : 'opacity-0 translate-y-10 transition-all duration-1000';
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-10 px-6 items-center relative z-10">
          ...
          <div className={`${fadeInClass('home')} transform rotate-6`}>
            <div className="aspect-[3/4] bg-gray-200 rounded-lg overflow-hidden shadow-xl">
              <img
                src="https://source.unsplash.com/random/900x1200?vinyl"
        ...
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center relative z-10">
          ...
          <div className={`${fadeInClass('products-intro')}`}>
            <div className="aspect-[4/3] overflow-hidden rounded-[30%_70%_70%_30%/30%_30%_70%_70%]">
              <img
                src="https://source.unsplash.com/random/800x600?70s,interior"
                alt="70s inspired interior"
                className="w-full h-full object-cover"
              />
            </div>
          </div>
      ...
      <section id="blog" className="py-24 bg-ninny-cashmere/60 relative">
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <BlogCard 
              title="Far Out Growing Tips"
              description="Dig these funky cultivation methods that'll give your garden those righteous vibrations and produce some dynamite results!"
            />
            <BlogCard 
              title="Groovy Cannabis Culture"
              description="Take a trip back to the 70s and explore how cannabis shaped the counterculture movement that's still rockin' our world today!"
            />
            <BlogCard 
              title="Peace & Pot Pairings"
              description="Get down with our outta sight strain recommendations to pair with those classic vinyl records for the ultimate cosmic experience!"
            />
          </div>
        ...
        <div className="max-w-3xl mx-auto px-6 text-center relative z-10">
          ...
          <form className={`flex flex-col sm:flex-row gap-4 ${fadeInClass('newsletter')}`}>
            <input 
              ...
              className="flex-1 px-4 py-3 rounded-full border border-ninny-water/40 focus:outline-none focus:border-ninny-water"
            />
            <input 
              type="email"
            ...
            <button 
              type="submit"
              className="bg-ninny-mandarin text-ninny-cashmere px-6 py-3 rounded-full font-bold uppercase tracking-wider hover:bg-ninny-marigold transition-colors"
            >
              Sign Up
            </button>
          </form>
